...
ENV BITCOIN_VERSION c23afab47fbe
ENV BITCOIN_URL https://github.com/benthecarman/bitcoin/releases/download/mutinynet-cat-lnhance/bitcoin-c23afab47fbe-arm-linux-gnueabihf.tar.gz
