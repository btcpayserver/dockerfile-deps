...
ENV BITCOIN_VERSION d4a86277ed8a
ENV BITCOIN_URL https://github.com/benthecarman/bitcoin/releases/download/paircommit/bitcoin-d4a86277ed8a-arm-linux-gnueabihf.tar.gz
