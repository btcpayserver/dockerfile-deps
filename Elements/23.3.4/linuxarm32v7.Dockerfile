...
ENV ELEMENTS_VERSION 23.3.4
ENV ELEMENTS_URL https://github.com/ElementsProject/elements/releases/download/elements-23.3.4/elements-23.3.4-arm-linux-gnueabihf.tar.gz
ENV ELEMENTS_SHA256 a0515bcc0b0e92a24d40e4a923abad34082e7f1fd78a17efd09f7a71cf3d4073
...
FROM --platform=arm debian:trixie-slim
